...
class UserServiceIntegrationTest @Autowired constructor(
    ...
    inner class getFindUserInfoByJwtToken {
        ...
        fun `JWT 토큰으로 사용자 정보 조회`() {
            val userTokenEntity : UserTokenEntity = UserTokenEntity().apply {
               refreshToken = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyU2VxIjozLCJlbWFpbCI6ImJhY2tqMTIzQG5hdmVyLmNvbSIsImlhdCI6MTc0MjkwNDQyNCwiZXhwIjoxNzQyOTA4MDI0fQ.nmOFb5PKjVpwwhJQ18Qq7KMoUiidl5z68KL0GjvJPBI"
            }

            val userDto = userService.getFindUserInfoByJwtToken(userTokenEntity)
