...
class UserServiceUnitTest {
    ...
    inner class GetUserInfoByJwtTokenTests {
        ...
        fun `성공적으로 사용자 정보를 조회`() {
            ...
            //When
           val resultValue = userService.getFindUserInfoByJwtToken(userTokenDto)
